...
static void draw_startup_navi(uint8_t f) {
    oled_write_cursor(1, 3, "H", false);
    oled_write_cursor(1, 4, "E", false);
    oled_write_cursor(1, 5, "L", false);
    oled_write_cursor(1, 6, "L", false);
    oled_write_cursor(1, 7, "O", false);

    oled_write_cursor(9, 3, "R", false);
    oled_write_cursor(9, 4, "A", false);
    oled_write_cursor(9, 5, "S", false);
    oled_write_cursor(9, 6, "G", false);
    oled_write_cursor(9, 7, "O", false);
    oled_write_cursor(9, 8, "N", false);
